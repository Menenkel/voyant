        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="flex flex-col">
                <span className="text-black text-xs font-medium">Travel smarter. Stay safer.</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/pricing" className="text-gray-600 hover:text-black transition-colors duration-200">Pricing</a></li>
              <li><a href="/features" className="text-gray-600 hover:text-black transition-colors duration-200">Features</a></li>
