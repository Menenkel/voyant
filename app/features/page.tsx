        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-black mb-6 animate-fade-in">
              VOYANT <span className="text-black">Features</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={feature.id}
              className={`bg-white rounded-lg p-8 border-2 ${feature.color} shadow-lg hover:shadow-lg transition-all duration-300 hover-lift animate-fade-in`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-delay" style={{animationDelay: '0.2s'}}>
              ...
              <Link
                href="/pricing"
                className="text-black hover:text-gray-600 px-8 py-3 font-medium transition-colors border-2 border-transparent hover:border-black rounded-lg"
              >
                View Pricing
              </Link>
            </div>
