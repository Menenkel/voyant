...
const generateRiskData = (destination: string) => {
...
const generateTravelDistance = (destination: string) => {
  ...
  return (airports as any)[normalizedDestination] || {
...
const generateSeasonalClimateForecast = (destination: string) => {
...
const generateComprehensiveRiskIndicators = (destination: string) => {
